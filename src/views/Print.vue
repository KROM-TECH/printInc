    ...
    >
      ...
      <div>
        ...
        <textarea
          ...
          name="Department"
          type="text"
          placeholder="Enter Detailed description on how you want the document"
          required
        ></textarea>
      </div>
      ...
      <div class="btnC">
        <button type="submit" id="btn" style="margin-top: 50px;">
          {{ print }}
        </button>
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      // this.getPrice(document.getElementById("book").files[0]);
